...
FLAGS:
    ...
    -T, --call-trace-all    Traces BDOS and BIOS calls
        --cpm3              Report CP/M version 3.1 instead of 2.2 (enables some CP/M Plus features)
...
- Preliminary support for CP/M+ (CP/M 3) with F_MULTISEC, P_CODe and Last Record Byt cound support. Thanks [Matze584](https://github.com/Matze584).
